...
public class Tool {
    ...
    public int toolID = -1, userID = -1;
    public String name = null, description = null, url = null, date = null;
    public boolean active;
    private List<Integer> referencesTo = null, referencesFrom = null;
    
    public Tool(ResultSet rs) {
        try {
    ...
    public synchronized void reloadReferencesFrom() {
        referencesFrom = ReferenceUtil.getReferenceIDsFrom("tool", "toolID", toolID);
    }
    ...
    public synchronized void reloadReferencesTo() {
        referencesTo = ReferenceUtil.getReferenceIDsTo("tool", "toolID", toolID);
    }
