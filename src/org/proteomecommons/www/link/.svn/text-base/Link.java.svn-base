...
public class Link {
    ...
    public synchronized void reloadReferencesFrom() {
        referencesFrom = ReferenceUtil.getReferenceIDsFrom("link", "linkID", linkID);
    }
    ...
    public synchronized void reloadReferencesTo() {
        referencesTo = ReferenceUtil.getReferenceIDsTo("link", "linkID", linkID);
    }
