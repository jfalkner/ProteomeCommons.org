<%-- 
    Document   : my-publications
    Created on : Oct 21, 2008, 3:47:37 PM
    Author     : James A Hill
--%><%@page contentType="text/html" pageEncoding="UTF-8" import="java.util.*, org.proteomecommons.www.publication.*, org.tranche.util.*"%><%
request.setAttribute("pageTitle", "My Publications");
...
if (user != null) {
    ...
    int count = PublicationUtil.getPublicationCount(filter, true, user.userID);
    int pageNum = 1;
    ...
    <div class="table">
        <div class="table-row">
            <div class="table-cell">
                <div class="table" style="vertical-align: top; border-bottom: 1px solid #333;">
                    <div class="table-row">
                        <div class="table-cell" style="font-size: 15pt; font-weight: bold;">My Publications</div><div class="table-cell" style="text-align: right">
                            <form action="my-publications.jsp" method="get" id="browsePublicationForm">
                                <div>
        ...
        <%
        List<Publication> publications = PublicationUtil.getPublications(filter, orderBy, "ASC", pageNum, perPage, true, user.userID);
