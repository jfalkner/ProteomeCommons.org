<%-- 
    Document   : my-data
    Created on : Sep 5, 2008, 3:26:20 PM
...
request.setAttribute("pageTitle", "My Data");
...
if (user != null) {
    ...
    int count = DataUtil.getDataCount(filter, true, user.userID);
    int pageNum = 1;
    ...
    <div class="table">
        <div class="table-row">
            <div class="table-cell">
                <div class="table" style="vertical-align: top; border-bottom: 1px solid #333;">
                    <div class="table-row">
                        <div class="table-cell" style="font-size: 15pt; font-weight: bold;">My Data</div><div class="table-cell" style="text-align: right">
                            <form action="my-data.jsp" method="get" id="browseDataForm">
                                <div>
        ...
        <%
        List<Data> data = DataUtil.getData(filter, orderBy, "ASC", pageNum, perPage, true, user.userID);
